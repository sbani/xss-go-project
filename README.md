# xss-go-project  <img src=a onerror="alert(1)"> 
[![Go Reference](https://pkg.go.dev/badge/github.com/sbani/xss-go-project.svg)](https://pkg.go.dev/github.com/sbani/xss-go-project)
[![Go Report Card](https://goreportcard.com/badge/github.com/sbani/xss-go-project)](https://goreportcard.com/report/github.com/sbani/xss-go-project)

This is an example Go XSS project <img src=a onerror="alert(1)">

It holds XSS payloads everywhere as an example.

## Markdown XSS  <img src=a onerror="alert(1)">
